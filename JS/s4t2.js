...
const questions = [
    {
        ...
        options: [
            { text: "4", explanation: "es correcto" },
            { text: "5", explanation: "dos mas dos es 4" },
            { text: "1", explanation: "'reads' /riːdz/ is in Presencuabt Simple Tense and correctly implies a habitual action." },
            { text: "9", explanation: "Incorrect. Continuous tenses describe actions happening at the moment of speaking, not habits." }
        ],
